...
jar_src = os.path.join(SCRIPT_DIR, '..', 'binaries', 'renaissance-gpl-0.16.0.jar')
jar_dst = '/mnt/renaissance/renaissance-gpl-0.16.0.jar'

subprocess.run(['cp', jar_src, jar_dst], check=True)
