...
#----
#TODO: Consider testing with AMD suggested options
...
for ((n=1; $n<=$NUM_OF_RUNS; n=$n+1)); do
  ...
  for ((gnum=1; $gnum<$GROUP_COUNT+1; gnum=$gnum+1)); do
    ...
    echo "    Start $BE_NAME"
    $JAVA $JAVA_OPTS_BE $SPEC_OPTS_BE -Xloggc:$GROUPID-gc.log $SPEC_OPTS_BE -jar /efs/html/SPECjbb2015/specjbb2015.jar -m BACKEND -G=$GROUPID -J=$JVMID $MODE_ARGS_BE > $BE_NAME.log 2>&1 &
    #----
    #TODO: Test with numa binding
